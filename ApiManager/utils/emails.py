...
def send_email_reports(receiver, html_report_path):
    ...
    msg.attach(body)
    # smtp = smtplib.SMTP()
    smtp = smtplib.SMTP_SSL(smtp_server, smtplib.SMTP_SSL_PORT)  # 如果端口是用SSL加密，请这样写代码。其中smtp是变量名
...
if __name__ == '__main__':
    ...
    send_email_reports('han_ziguo@163.com', 'D:\\HttpRunnerManager\\reports\\2018-06-05 15-58-00.html')
